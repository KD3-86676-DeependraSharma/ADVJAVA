...
public class User extends BaseEntity {
	...
	private byte[] image;
	//User 1--->1 Address
	@OneToOne(cascade =CascadeType.ALL) //default fetch type : EAGER
...
//	@OneToOne(cascade =CascadeType.ALL) //default fetch type : EAGER
	...
	public void addAddress(Address newAdr) {
		this.userAddress=newAdr;	
	}
	public void addAadhar(AadharCard newAadr) {
		this.userAdhaar=newAadr;	
	}
}
